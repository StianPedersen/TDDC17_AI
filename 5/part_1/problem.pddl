(define (problem Move_balls)
    (:domain Shakey)
    (:objects ; All objects represented in shakey problem described in the task
    ...
    (:init
        ; place balls and boxes, empty grippers
        (in_room s room_a)
    ...
    (:goal ; our self made object to fufill
        (and
